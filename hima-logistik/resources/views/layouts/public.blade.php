            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-dark-400 text-sm">
                        <li>
                            <a href="mailto:hima.logistikbisnis@email.com" class="flex items-center gap-3 hover:text-primary-400 transition-colors">
                                ...
                                hima.logistikbisnis@email.com
                            </a>
                        </li>
                        <li>
                            <a href="https://instagram.com/hima.logistikbisnis" target="_blank" rel="noopener noreferrer" class="flex items-center gap-3 hover:text-primary-400 transition-colors">
